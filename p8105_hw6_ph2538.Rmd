...
This plot shows that most of the residuals fall around 0 for mother's weight at delivery, which means it may be a good model.
...
Similarly, this plot shows that most of the residuals fall around 0 for family income, which means it may be a good model.
