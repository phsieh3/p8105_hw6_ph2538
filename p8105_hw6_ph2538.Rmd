...
This is a linear regression model of birthweight with family income and mother's race as predictors.
...
As mother race is a categorical variable with 4 categories, this plot shows four clusters. 
...
The hc_len_sex model is the best because it has the lowest RMSE value of `r rmse(lm_hc_len_sex, birthweight_data)`. In contrast, the inc_mrace is the worst model with the highest RMSE value of `r rmse(lm_inc_mrace, birthweight_data)`
