...
As mother race is a categorical variable with 4 categories, this plot
shows four clusters.
...
The hc\_len\_sex model is the best because it has the lowest RMSE value
of 287.4692441. In contrast, the inc\_mrace is the worst model with the
highest RMSE value of 488.1710457
