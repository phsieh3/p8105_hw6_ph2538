...
weight at delivery, which means it may be a good model.
...
Similarly, this plot shows that most of the residuals fall around 0 for
family income, which means it may be a good model.
...
![](p8105_hw6_ph2538_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](p8105_hw6_ph2538_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
(including the three-way interaction) between these (hc\_len\_sex) is
the best model because it has the lowest RMSE value of 287.4692441. In
contrast, model using monthly family income and mother’s weight at
delivery (inc\_delwt) is the worst model with the highest RMSE value of
484.7933794
